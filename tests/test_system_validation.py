...
def test_overall_pass_and_every_component_is_timed(tmp_path) -> None:
    ...
    assert result.components_checked == 17
    ...
    assert {"Storage", "Live Monitor", "Paper Brokerage", "Trade Lifecycle Manager", "Paper Journal", "Daily Reports", "Daily Scheduler", "Dashboard", "Observability"} <= names
